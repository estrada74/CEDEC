...
<title>CEDEC - Registrar sector</title>
<?php
        ...
        <div class="row">
            <div class="page-header">
                <div class="d-flex align-items-center">
                    <h2 class="page-header-title">Registrar sector</h2>
                ...
                <div class="widget has-shadow">
                    ...
                    <div class="widget-body">
                        ...
                        <form class="needs-validation" novalidate="" method="post">
                          ...
                          $agregar -> registrarSectoresController("sectores");
                        ?>
                            <div class="form-group row d-flex align-items-center mb-5">
                                <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">Sector <span class="text-danger ml-2">*</span></label>
                                <div class="col-lg-5">
                                    <input type="text" class="form-control" name="campo"  onkeyup="javascript:this.value=this.value.toUpperCase();" placeholder="Ingrese el nombre del Sector" required="">
                                    <div class="invalid-feedback">
                                        Por favor ingresa un sector
                                    </div>
                                </div>
                            </div>
