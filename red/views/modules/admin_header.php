                ...
                <nav class="navbar fixed-top">         
                    ...
                    <div class="navbar-holder d-flex align-items-center align-middle justify-content-between">
                        ...
                        <div class="navbar-header">
                            <a href="index.php?action=dashboard" class="navbar-brand">
                        ...
                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center pull-right">
                            ...
                            <li class="nav-item dropdown">
                                    ...
                                    <a id="user" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><img src="views/assets/img/avatar/avatar-01.jpg" alt="..." class="avatar rounded-circle">
                                    </a>
                                ...
                                <ul aria-labelledby="user" class="user-size dropdown-menu">
                                    <li class="welcome">
                                        <?php if ($_SESSION["id_rol"]!=2){ ?>
                                            ...
                                            <a href="index.php?action=editar_informacion&id=<?php echo $_SESSION["id"];?>" class="edit-profil"><i class="la la-gear"></i></a>
                                        <?php } ?>
                                    ...
                                    <li>
                                        <a href="app-mail.html" class="dropdown-item"> 
                                            Nombre: <?php 
                                                        if ($_SESSION["id_rol"]==1){
                                                    echo $_SESSION["nombre"]." ".$_SESSION["a_paterno"]." ".$_SESSION["a_materno"];
                                                }elseif ($_SESSION["id_rol"]==2) {
                                                    echo $_SESSION["nombre_representante"];
                                                }else{
                                                    echo "string";
                                                }/*
                                                        if ($_SESSION["id_rol"]==1)
