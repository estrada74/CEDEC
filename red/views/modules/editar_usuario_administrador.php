        ...
        <div class="row">
            <div class="page-header">
                <div class="d-flex align-items-center">
                    <h2 class="page-header-title">Editar Informacion de administrador</h2>
                ...
                <div class="widget has-shadow">
                    ...
                    <div class="widget-body">
                        <div class="alert  alert-primary" role="alert">
                                            <strong>Hey!, Estas apunto de editar el administrador:</strong>   <?php echo $datos["nombre"]." ".$datos["a_paterno"]." ".$datos["a_materno"];  ?>
                      </div>
                        <form class="needs-validation" novalidate="" method="post">
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                             ...
                             <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-5">
                                    <input type="text" class="form-control" value="<?php echo $datos["a_materno"] ?>" name="txtApellidoM" placeholder="Apellido materno">
                                    <div class="invalid-feedback">
