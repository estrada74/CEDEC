...
<title>CEDEC - Registrar representante</title>
<?php
        ...
        <div class="row">
            <div class="page-header">
                <div class="d-flex align-items-center">
                    <h2 class="page-header-title">Registrar representante legal</h2>
            ...
            <div class="col-xl-12">
                ...
                <div class="widget has-shadow">
                    ...
                    <div class="alert  alert-primary" role="alert">
                                            <strong>Registrar representante</strong>
                      </div>
                      
                        <form class="needs-validation" novalidate="" method="post">
                          <?php 
                          $agregar = new MvcController();
                          $agregar -> registrarRepresentanteLegalController();
                        ?>
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-5">
                                    <input type="text" class="form-control" name="txtNomRepresentante" placeholder="Ingrese el nombre del representante legal" required=""  onkeyup="javascript:this.value=this.value.toUpperCase();">
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-5">
                                    <div class="input-group">
                                        ...
                                        <input maxlength="15" type="number" class="form-control" placeholder="Ingrese el número teléfonico del representante" required=""  onkeyup="javascript:this.value=this.value.toUpperCase();" name="txtTel">
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-lg-5">
                                    <select name="selectEstudios" class="custom-select form-control" required=""  onkeyup="javascript:this.value=this.value.toUpperCase();">
                                       <option value="">Seleccione</option>
                                        ...
                                        <option value="PROFECIONAL TÉCNICA">PROFESIONAL TÉCNICA</option>
