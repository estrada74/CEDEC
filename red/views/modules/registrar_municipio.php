...
<title>CEDEC - Registrar municipio</title>
<?php
        ...
        <div class="row">
            <div class="page-header">
                <div class="d-flex align-items-center">
                    <h2 class="page-header-title">Registrar municipio</h2>
                ...
                <div class="widget has-shadow">
                    ...
                    <div class="widget-body">
                        <div class="alert  alert-primary" role="alert">
                                            <strong>Registrar Municipio</strong>
                      </div>
                        <form class="needs-validation" novalidate="" method="post">
                          <?php 
                          $agregar = new MvcController();
                          $agregar -> registrarSectoresController("municipios");
                        ?>
                            <div class="form-group row d-flex align-items-center mb-5">
                                <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">Municipio <span class="text-danger ml-2">*</span></label>
                                <div class="col-lg-5">
                                    <input type="text" class="form-control" name="campo"   placeholder="Ingrese el nombre del municipio" required="">
