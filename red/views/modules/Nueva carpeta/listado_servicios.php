    ...
    <div class="row">
        <div class="page-header">
            <div class="d-flex align-items-center">
                <h2 class="page-header-title">Listado de servicios</h2>
    ...
    <div class="widget has-shadow">
        <div class="widget-header bordered no-actions d-flex align-items-center">
            <a title="Dar servicio" href="index.php?action=agregar_servicio"> 
              <button type="button" class="btn btn-success mr-1 mb-2"><i class="la la-plus-circle"></i>Agregar servicio</button>
            </a>
        </div>
                        ...
                        <table id="sorting-table" class="table mb-0 dataTable no-footer" role="grid" aria-describedby="sorting-table_info">
                            ...
                            <tbody>
                              <?php
                                ...
                                $usuarios -> vistaServiciosController();
                              ?>
                            </tbody>
                        </table>
                    </div>
...
<?php 
    ...
    $cate -> borrarController("cw_servicios","id_servicio","listado_servicios");
?>
<!-- END content inner--> 
</div>
